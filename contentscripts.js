...
chrome.extension.sendRequest({}, function(response) { 
      	...
      	$(document).xpathEvaluate('/html/body/div/div/div[2]/form/table/tbody/tr[5]/td[2]/input').val("xxxxx");
      	$(document).xpathEvaluate('/html/body/div/div/div[2]/form/table/tbody/tr[6]/td[2]/input').val("xxxxx");
